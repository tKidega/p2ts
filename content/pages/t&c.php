<?php
	define('TITLE','Terms and Conditions Page');
...
<html lang='en'>
	...
	<body>
		...
		<div id='site_nav'>
			<div id='fix_nav'>
				<?php include'../assets/scripts/php/level_02/pub_t&c/nav_t&c.php'; ?>
			</div>
			<div style='clear:both'></div>
		</div>
		<div style='clear:both'></div>
		<div id='site_body'>
			<?php include'../assets/scripts/php/level_02/pub_t&c/body_t&c.php'; ?>
		</div>
		<div style='clear:both'></div>
